...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT_wrapper(
    KC_TILD, _______________HIGH_FUNC_LEFT______________, _______________HIGH_FUNC_RIGHT_____________, KC_DEL,  \
  ...
  [_FN1] = LAYOUT_wrapper(
    ...
    _______, KC_APP,  HANJA,   KC_LNG1, KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, CLEAR,   _______, \
    _______, _______, _______, _______,     _______,      _______,       _______,    _______, _______, _______
  ),
  ...
  [_ADJUST] = LAYOUT_wrapper(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BRID, KC_BRIU, KC_MUTE, KC_VOLD, KC_VOLU, XXXXXXX, QK_BOOT, XXXXXXX, \
